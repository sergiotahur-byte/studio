...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
El incumplimiento en el pago del arriendo es una de las situaciones más estresantes para un propietario. Afortunadamente, la ley colombiana ofrece herramientas claras para actuar.
...
En **Recuperaciones Jurídicas** somos expertos en estos procesos. Contáctenos para recibir asesoría.
  ...
  },
  {
    ...
    content: `
Recuperar un inmueble no tiene por qué ser una pesadilla. Siga estas claves:
...
**4. Asesórese con expertos:** Un abogado con experiencia en derecho inmobiliario puede guiarlo para tomar las decisiones correctas, acelerar los tiempos y proteger sus derechos.
  ...
  },
  {
    ...
    content: `
La mejor forma de evitar problemas con un arrendatario es protegiéndose desde el inicio.
